...
public class CsvConvert {
    ...
    // Constructor
    public CsvConvert (double classP , double sex , List<Double> listAge, List<Double> listFamily , List<Double> listCost , double embarked) {
        this.classP = classP;
        this.sex = sex ;
     ...
     public void statisticsCsv () {
        try {
            File output = new File(Constants.PATH_TO_DATA_FILE);
